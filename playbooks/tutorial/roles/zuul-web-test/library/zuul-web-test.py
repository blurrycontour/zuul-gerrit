...
def run():
    ...
    # In case of assert errors due to a change that legitimatly modifies
    # pages layout, It is suggested to install Selenium extension in your
    # browser to get the new element data more easily.
