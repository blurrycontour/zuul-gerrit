...
class ZuulWeb(object):
    ...
    def __init__(self, listen_address, listen_port,
        ...
        api = ZuulWebAPI(self)
        route_map.connect(None, '/api/info',
                          controller=api, action='info')
        route_map.connect(None, '/api/tenants',
                          controller=api, action='tenants')
        route_map.connect(None, '/api/tenant/{tenant}/info',
                          controller=api, action='tenant_info')
        route_map.connect(None, '/api/tenant/{tenant}/status',
                          controller=api, action='status')
        route_map.connect(None, '/api/tenant/{tenant}/jobs',
                          controller=api, action='jobs')
        route_map.connect(None, '/api/tenant/{tenant}/key/{project:.*}.pub',
                          controller=api, action='jobs')
