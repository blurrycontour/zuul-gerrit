...
class ZuulWeb(object):
    ...
    def __init__(self, listen_address, listen_port, gear_server,
                 ...
                 zk_auth=None, zk_timeout=None, zk_tls_cert=None,
                 zk_tls_key=None, zk_tls_ca=None, authenticators=None,
                 command_socket=None):
        ...
        if zk_hosts:
            self.zk.connect(hosts=zk_hosts, read_only=True,
                            timeout=zk_timeout, auth_data=zk_auth,
                            tls_cert=zj_tls_cert, tls_key=zk_tls_key,
                            tls_ca=zk_tls_ca)
