...
class SkippedUnparsedConfig(object):
    """A marker object that indicates no configuration was loaded for a
    branch (because all items are skipped).
