...
class Pipeline(object):
    ...
    def __init__(self, name: str, tenant: "Tenant"):
        ...
        self.supercedes: List[Pipeline] = []
        self.triggers: List[BaseTrigger] = []
        self.enqueue_actions: List = []
        self.start_actions: List = []
        self.success_actions: List = []
        self.failure_actions: List = []
        self.merge_failure_actions: List = []
        self.no_jobs_actions: List = []
        self.disabled_actions: List = []
        self.dequeue_actions: List = []
...
class QueueItem(object):
    ...
    def __init__(
        ...
        self.item_ahead: QueueItem = None
        self.items_behind: List[QueueItem] = []
        self.enqueue_time: float = None
        self.report_time: float = None
        self.dequeue_time: float = None
        self.reported = False
        ...
        self.project_pipeline_config: ProjectPipelineConfig = None
        self.job_graph: JobGraph = None
        # Cached job graph of previous layout
        self._old_job_graph: JobGraph = None
        self._cached_sql_results: Dict = {}
        ...
        self.dynamic_state: DefaultDict = defaultdict(dict)
...
class Layout(object):
    ...
    def _updateOverrideCheckouts(
        self, override_checkouts: Dict, job: Job
    ) -> None:
