...
class JobRequest:
    ...
    def __init__(self, uuid, precedence=None, state=None, result_path=None,
        ...
        self.zuul_trace_parent = zuul_trace_parent
    ...
    def toDict(self):
        return {
            ...
            "zuul_trace_parent": self.zuul_trace_parent,
        }
...
class BuildRequest(JobRequest):
    ...
    def __init__(self, uuid, zone, build_set_uuid, job_name, tenant_name,
                 pipeline_name, event_id, precedence=None, state=None,
                 result_path=None, zuul_trace_parent=None):
        super().__init__(
            uuid, precedence, state, result_path, zuul_trace_parent)
        self.zone = zone
        self.build_set_uuid = build_set_uuid
        self.job_name = job_name
        self.tenant_name = tenant_name
    ...
    def fromDict(cls, data):
        request = cls(
            ...
            state=data["state"],
            result_path=data["result_path"],
            zuul_trace_parent=data.get("zuul_trace_parent"),
        )
