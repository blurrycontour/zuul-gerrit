...
class Capabilities(object):
    ...
    """
    def __init__(self, job_history: bool=False, graphs: bool=False):
...
class WebInfo(object):
    ...
    def __init__(self, websocket_url: str=None, endpoint: str=None,
                 capabilities: Capabilities=None, graphite_url: str=None,
                 graphite_prefix: str=None):
...
class TenantWebInfo(object):
    ...
    def __init__(self, name: str, info: WebInfo=None):
        self.name = name
