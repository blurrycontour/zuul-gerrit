...
class QueueItem(object):
    ...
    def formatUrlPattern(self, url_pattern, job=None, build=None):
        ...
        try:
            ...
            self.log.debug("url_pattern: %s" % url_pattern)
            self.log.debug("change attributes: %s" % self.change.__dict__.keys())
            self.log.debug("pipeline attributes: %s" % self.pipeline.__dict__.keys())
            self.log.debug("build attributes: %s" % build.__dict__.keys())
            self.log.debug("job attributes: %s" % job.__dict__.keys())
            self.log.debug("item attributes: %s" % self.__dict__.keys())
        except Exception:
