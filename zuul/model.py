...
class Node(ConfigObject):
    ...
    def __init__(self, name: Any, label: Optional[str]):
        ...
        self.state_time: float = time.time()
...
class ManagementEvent(AbstractEvent):
    ...
    def toDict(self) -> Dict[str, Any]:
        d = super().toDict()
        d["zuul_event_id"] = self.zuul_event_id
        return d
...
class MergeCompletedEvent(ResultEvent):
    ...
    def toDict(self) -> Dict[str, Any]:
        d = super().toDict()
        d["build_set"] = self.build_set
        d["merged"] = self.merged
        d["updated"] = self.updated
        d["commit"] = self.commit
        d["files"] = list(self.files)
        d["repo_state"] = dict(self.repo_state)
        d["item_in_branches"] = list(self.item_in_branches)
        return d
