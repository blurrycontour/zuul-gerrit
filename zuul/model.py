...
class Job(ConfigObject):
    ...
    def getConfigHash(self, tenant):
        ...
        # Use json_dumps to strip any ZuulMark entries
        hasher.update(json_dumps(job_dict).encode('utf8'))
...
class QueueItem(zkobject.ZKObject):
    ...
    def hasJobGraph(self):
        ...
        return (self.current_build_set and
                self.current_build_set.job_graph is not None)

    def getJobs(self):
        if not (self.live and self.current_build_set
                and self.current_build_set.job_graph):
            return []
    ...
    def getConfigErrors(self):
        return self.current_build_set and self.current_build_set.config_errors
    ...
    def formatUrlPattern(self, url_pattern, job=None, build=None):
        ...
        buildset = self.current_build_set
        safe_buildset = buildset.getSafeAttributes() if buildset else {}
    ...
    def formatStatusUrl(self):
        ...
        if self.current_build_set and self.current_build_set.result:
    ...
    def makeMergerItem(self):
        ...
        buildset_uuid = self.current_build_set and self.current_build_set.uuid
    ...
    def getMergeMode(self):
        ...
        while item:
            if item.current_build_set and item.current_build_set.job_graph:
