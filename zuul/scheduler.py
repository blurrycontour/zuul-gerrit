...
class Scheduler(threading.Thread):
    ...
    def _runStats(self):
        ...
        self.statsd.gauge('zuul.executors.unzoned.accepting', unzoned_accepting)
        self.statsd.gauge('zuul.executors.unzoned.jobs_running', unzoned_running)
