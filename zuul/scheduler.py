...
# TODO: set max size from config
MAX_EVENTS_WAITING_FOR_REPLICATION=512
...
class Scheduler(threading.Thread):
    ...
    def __init__(self):
        ...
        self.events_waiting_for_replication = AgeingLastUpdatedOrderedDict(
                MAX_EVENTS_WAITING_FOR_REPLICATION)
