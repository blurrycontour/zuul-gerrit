...
def deep_format(obj, paramdict):
    ...
    if isinstance(obj, str):
        ...
        ret = {}
        for item in obj:
            # Make sure to expand dictionnary keys too, this is specific
            # too Zuul and thus diverge from the original implementation
...
class Scheduler(threading.Thread):
    ...
    def _parseConfig(self, config_path):
        ...
        for conf_project_template in data.get('projecttemplates', []):
        ...
        for config_project in data.get('projects', []):
            ...
            for requested_template in config_project.get('template', []):
                # Fetch the template from 'projecttemplates'
                ...
                config_project = dict(
                    config_project.items() + expanded.items())
