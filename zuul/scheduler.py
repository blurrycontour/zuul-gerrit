...
class Scheduler(threading.Thread):
    ...
    def _doBuildCompletedEvent(self, event):
        ...
        try:
            ...
            # TODO(mhu) remove
            self.log.debug(
                'Change: %s %s %s' % (build.build_set.item.change.ref,
                                      build.build_set.item.change.oldrev,
                                      build.build_set.item.change.newrev))
            ...
            # TODO(mhu) remove
            self.log.debug('Trying autohold key: %s' % autohold_key_commit)
