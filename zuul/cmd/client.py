...
class Client(zuul.cmd.ZuulApp):
    ...
    def parse_arguments(self):
        ...
        cmd_enqueue = subparsers.add_parser('enqueue-ref', help='enqueue a ref')
        cmd_enqueue.add_argument('--trigger', help='trigger name',
                                 required=True)
        cmd_enqueue.add_argument('--pipeline', help='pipeline name',
                                 required=True)
        ...
        cmd_enqueue.add_argument('--ref', help='ref name',
                                 required=True)
        cmd_enqueue.add_argument('--oldrev', help='old revision',
                                 default='0000000000000000000000000000000000000000')
        cmd_enqueue.add_argument('--newrev', help='new revision',
                                 default='0000000000000000000000000000000000000000')
