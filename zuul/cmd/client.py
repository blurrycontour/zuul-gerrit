...
class Client(zuul.cmd.ZuulApp):
    ...
    def parse_arguments(self):
        ...
        show_jobs.add_argument('--limit', type=int, help="Limit the query")
        show_jobs.add_argument('--skip', type=int, help="Skip rows")
    ...
    def print_job_controller(self, path, fields):
        ...
        if self.args.limit:
            params.append(('limit', self.args.limit))
        if self.args.skip:
            params.append(('skip', self.args.skip))
    ...
    def show_builds(self):
        return self.print_job_controller(
            "/builds?", ["pipeline", "job_name", "project",
                         "change", "patchset", "ref",
