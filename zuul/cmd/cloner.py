...
class Cloner(zuul.cmd.ZuulApp):
    ...
    def parse_arguments(self):
        ...
        project_env.add_argument(
            ...
            help=('project-specific branch to checkout which takes '
                  'precedence over --branch if it is provided.')
            )
        ...
        # --project-branch tempest=stable/havana
