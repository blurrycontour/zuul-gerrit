...
SafeLoader.SafeRepresenter.add_constructor(UnsafeTag.yaml_tag, UnsafeTag.from_yaml)
SafeDumper.SafeRepresenter.add_multi_representer(UnsafeTag, UnsafeTag.to_yaml)
