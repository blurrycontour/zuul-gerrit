...
class GerritWatcher(threading.Thread):
    ...
    def _run(self):
        try:
            ...
            self.log.debug("paramiko.SSHClient keepalive interval is set to %d" % self.keepalive_interval)
...
class GerritConnection(BaseConnection):
    ...
    def __init__(self, connection_name, connection_config):
        ...
        self.keepalive_interval = int(self.connection_config.get('keepalive_interval', 0))
