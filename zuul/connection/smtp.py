...
class SMTPConnection(BaseConnection):
    ...
    def __init__(self, connection_name, connection_config):
        ...
        self.smtp_port = self.connection_config.get('smtp_port', 25)
        self.smtp_default_from = self.connection_config.get(
            'smtp_default_from', 'zuul')
        self.smtp_default_to = self.connection_config.get(
            'smtp_default_to', 'zuul')

    def _send_mail(self, subject, message, from_email=None, to_email=None):
