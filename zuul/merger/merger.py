...
class Repo(object):
    ...
    def setRemoteUrl(self, url, zuul_event_id=None):
        ...
        try:
            # Update the new remote URL as it is used for the initial
            ...
            # the Git URL after a failure. This prevents us from using
            # outdated credentials that might still be stored in the
            # Git config as part of the URL.
