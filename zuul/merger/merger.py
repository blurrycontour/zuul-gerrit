...
class Merger(object):
    def __init__(self, working_root: str, connections: ConnectionRegistry,
                 zk_client: ZooKeeperClient, email: str, username: str,
                 speed_limit: str, speed_time: str,
                 cache_root: Optional[str] = None,
                 logger: Optional[Logger] = None,
                 execution_context: bool = False, git_timeout: int = 300):
        # one optional logger and one with default?
        self.parent_logger: Optional[Logger] = logger
        self.log: Logger = logger or logging.getLogger("zuul.Merger")
    ...
    def _addProject(self, hostname, project_name, url, sshkey, zuul_event_id):
        ...
        try:
            ...
            repo = Repo(
                ...
                logger=self.parent_logger, git_timeout=self.git_timeout,
