...
class LaunchServer(object):
    ...
    def _launch(self, job):
        ...
        with TempDir() as root:
            ...
            # From: http://docs.ansible.com/ansible/developing_api.html
            ...
            # TODOv3: this should come from the job definition
            play_source =  dict(
                name = "Ansible Play",
                hosts = 'localhost',
                gather_facts = 'no',
                tasks = [ dict(action=dict(module='debug',
                                           args=dict(msg='Hello Galaxy!'))) ]
            )
