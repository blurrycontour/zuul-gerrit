...
class Nodepool(object):
    ...
    def returnNodeSet(self, nodeset, build=None, zuul_event_id=None):
        ...
        self._unlockNodes(nodeset.getNodes(), zuul_event_id=zuul_event_id)
    ...
    def unlockNodeSet(self, nodeset, zuul_event_id=None):
        self._unlockNodes(nodeset.getNodes(), zuul_event_id)

    def _unlockNodes(self, nodes, zuul_event_id=None):
        for node in nodes:
            try:
    ...
    def lockNodeSet(self, nodeset, request_id, zuul_event_id=None):
        self._lockNodes(nodeset.getNodes(), request_id, zuul_event_id)

    def _lockNodes(self, nodes, request_id, zuul_event_id=None):
        ...
        try:
            ...
            self._unlockNodes(locked_nodes, zuul_event_id)
            raise
