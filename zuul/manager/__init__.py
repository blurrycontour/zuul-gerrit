...
class PipelineManager(metaclass=ABCMeta):
    ...
    def updateCommitDependencies(self, change, change_queue, event):
        ...
        update_attrs = dict(commit_needs_changes=new_commit_needs_changes,topic_needs_changes=new_topic_needs_changes)
        
        if change.commit_needs_changes != update_attrs['commit_needs_changes'] or change.commit_needs_changes != update_attrs['topic_needs_changes']:
