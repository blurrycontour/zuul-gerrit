...
class PipelineManager(metaclass=ABCMeta):
    ...
    def updateCommitDependencies(self, change, change_queue, event):
        ...
        commit_needs_changes = change.commit_needs_changes != update_attrs['commit_needs_changes']
        topic_needs_changes = change.commit_needs_changes != update_attrs['topic_needs_changes']

        if (commit_needs_changes or topic_needs_changes):
