...
class PipelineManager(metaclass=ABCMeta):
    ...
    def scheduleReport(self, action_reporters, item, message=None,
        ...
        if action_reporters:
            for reporter in action_reporters:
                ...
                reporter.dispatchReport(item, report_uuid, report_state)
    ...
    def removeItem(self, item):
        ...
        if item.report_state:
            # If result reporting is already in progress do not remove since
            # this item will be dequeued after reporting.
            return
