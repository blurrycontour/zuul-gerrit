...
class TenantParser(object):
    ...
    @staticmethod
    def _parseConfigProjectLayout(data, source_context, tenant=None):
        ...
        try:
            ...
            if tenant:
                ...
                # In dynamic reconf then raises the exception
                raise
        return config

    @staticmethod
    def _parseUntrustedProjectLayout(data, source_context, tenant=None):
        config = model.UnparsedTenantConfig()
        try:
            with early_configuration_exceptions(source_context):
                config.extend(safe_load_yaml(data, source_context))
