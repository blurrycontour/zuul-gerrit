...
class TenantParser(object):
    ...
    @staticmethod
    def _loadProjectKeys(project_key_dir, source, project):
        project.private_key_file = (
            os.path.join(project_key_dir, source.name,
                         project.name + '.pem'))
    ...
    def _generateKeys(project):
        ...
        TenantParser.log.info(
            "Generating RSA keypair for project %s at %s" % (
    ...
    def _loadTenantConfigRepos(project_key_dir, connections, conf_tenant):
        ...
        for source_name, conf_source in conf_tenant.get('source', {}).items():
            ...
            for conf_repo in conf_source.get('config-repos', []):
                ...
                TenantParser._loadProjectKeys(project_key_dir, source, project)
