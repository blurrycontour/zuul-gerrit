...
class ProjectParser(object):
    ...
    def generateKeys(project):
        #private_key_file = '/var/lib/zuul/private/' + project.name
        #public_key_file = '/var/lib/zuul/keys' + project.name
        private_key_file = '/tmp/var/lib/zuul/private/' + project.name
        public_key_file = '/tmp/var/lib/zuul/keys/' + project.name
        ...
        if not os.path.isfile(private_key_file):
            ...
            project.private_key_file = private_key_file
            project.public_key_file = public_key_file
