...
class PipelineParser(object):
    ...
    def getSchema(self):
        ...
        pipeline['trigger'] = vs.Required(
            self.getDriverSchema('trigger', self.connections))
...
class TenantParser(object):
    ...
    def fromYaml(base, project_key_dir, merger, conf, old_tenant):
        self.getSchema()(conf)
    ...
    def _loadTenantProjects(self, project_key_dir, connections, conf_tenant):
        config_projects = []
        untrusted_projects = []
    ...
    def _loadTenantInRepoLayouts(config_projects, untrusted_projects,
                                 cached, tenant):
    ...
    def _parseLayoutItems(self, layout, tenant, data,
        ...
        flattened__projects = self._flattenProjects(data.projects, tenant)
    ...
    def _flattenProjects(self, projects, tenant):
        ...
        for config_project in projects:
            with configuration_exceptions('project', config_project):
                ...
                project['name'] = name
                result_projects.setdefault(name, []).extend(config_project)
