...
class TenantParser(object):
    ...
    @classmethod
    def getSchema(
        cls, connections: 'connections.ConnectionRegistry'
    ) -> vs.Schema:
    ...
    def filterUntrustedProjectYAML(
        self, data: model.UnparsedConfig, loading_errors
    ):
...
class ConfigLoader(object):
    ...
    def __init__(
        ...
        self.scheduler = scheduler
        self.merger = merger
        self.keystorage: KeyStorage = None
        if key_dir:
    ...
    def reloadTenant(
        ...
        tenant: model.Tenant,
        ansible_manager: AnsibleManager,
        unparsed_abide: model.UnparsedAbideConfig = None
    ) -> model.Abide:
