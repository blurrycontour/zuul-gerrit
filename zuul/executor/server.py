...
class AnsibleJob(AnsibleJobBase):
    """An object to manage job ran by the executor service.

    This executor.AnsibleJob provides an abstraction around job thread
    execution with pause and resume facility. This implementation is
    also responsible to send result data back to the gearman.
    """
    def __init__(self, executor_server, job):
        ...
        super().__init__(
            ...
            execution_wrapper_name=executor_server.execution_wrapper_name,
...
class ExecutorServer(object):
    ...
    def __init__(self, config, connections={}, jobdir_root=None,
        ...
        self.execution_wrapper_name = 'bubblewrap'
