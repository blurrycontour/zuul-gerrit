...
class AnsibleJob(object):
    ...
    def pause(self):
        ...
        self.executor_server.zookeeper.setBuildData(self.build_item.path, data)
...
class ExecutorServer(BaseMergeServer):
    ...
    def __init__(self, config, zk, connections, jobdir_root=None,
        ...
        zone = self.zone or self.zookeeper.ZUUL_BUILDS_DEFAULT_ZONE
        self.zookeeper.registerBuildZone(zone)
        self.zookeeper.registerBuildTreeCacheListener(
    ...
    def start(self):
        ...
        self.zookeeper.registerExecutor(self.hostname)
    ...
    def stop(self):
        ...
        self.stop_repl()
        self.zookeeper.unregisterExecutor(self.hostname)
    ...
    def __build_job_worker_loop(self):
        while self._running:
            ...
            for node_path, build_item in items:
                self.zookeeper.resumeBuildAttempt(node_path, self.resumeJob)
                self.zookeeper.cancelBuildAttempt(node_path, self.stopJob)
        ...
        if self.accepting_work:
            ...
            for sensor in self.sensors:
                ...
                if not ok:
                    ...
                    self.zookeeper.setExecutorAcceptingWork(
                        self.hostname, False)
