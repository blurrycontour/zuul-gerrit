...
class GearmanAnsibleContextManager(AnsibleJobContextManager):
    ...
    def __init__(self, executor_server, gearman_job):
        ...
        self.log = AnsibleJobLogAdapter(logger, {'job': self.unique})
...
class ExecutorServer(object):
    ...
    def __init__(self, config, connections={}, jobdir_root=None,
        ...
        # House keeping check for _job_context_class
        assert issubclass(self._job_context_class, AnsibleJobContextManager)
        self.config = config
    ...
    def executeJob(self, job):
        ...
        self.job_workers[job.unique] = self._job_context_class(
            self, job)
