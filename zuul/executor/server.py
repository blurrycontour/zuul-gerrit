...
class AnsibleJob(object):
    ...
    def _emit_playbook_banner(self, playbook, step, phase, result=None):
    ...
    def runAnsiblePlaybook(self, playbook, timeout, success=None,
        ...
        self._emit_playbook_banner(playbook, 'START', phase)
        ...
        self._emit_playbook_banner(playbook, 'END', phase, result=result)
        return result, code
