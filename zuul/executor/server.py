...
class AnsibleJob(object):
    ...
    def loadRepoState(self):
        merge_repo_state = MergeRepoState.fromZK(
            self.executor_server.zk_context,
            self.arguments['merge_repo_state_ref'])
        extra_repo_state = ExtraRepoState.fromZK(
            self.executor_server.zk_context,
            self.arguments['extra_repo_state_ref'])
        d = {}
