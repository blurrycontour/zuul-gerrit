    ...
    def runAnsible(self, cmd, timeout, playbook, wrapped=True):
        ...
        if ret == 3 or os.path.exists(self.jobdir.job_unreachable_file):
            ...
            for line in syntax_buffer:
                ...
                # that are not detected by ansible. These can be detected if
                # the string 'FATAL ERROR DURING FILE TRANSFER' is in the
                # ansible output. In this case we should treat the host as
                # unreachable and retry the job.
