...
class AnsibleJob(object):
    ...
    def __init__(self, executor_server, job):
        ...
        plugin_dir = self.executor_server.ansible_manager.getAnsiblePluginDir(
            self.executor_server.ansible_plugin_dir_root)
...
class ExecutorServer(object):
    ...
    def __init__(self, config, connections={}, jobdir_root=None,
        ...
        self.ansible_plugin_dir_root = os.path.join(zuul_dir, 'ansible')

        os.makedirs(self.ansible_plugin_dir_root, mode=0o0755)
        _copy_ansible_files(zuul.ansible, self.ansible_plugin_dir_root)
