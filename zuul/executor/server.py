...
class AnsibleJob(object):
    ...
    def getHostList(self, args):
        ...
        for node in args['nodes']:
            # NOTE(mordred) This assumes that the nodepool launcher and the
            #               zuul executor both have similar network
            #               characteristics, as the launcher will do a test
            #               for ipv6 viability and if so, and if the node has
            #               an ipv6 address, it will be the interface_ip.
            #               force-ipv4 can be set to True in the clouds.yaml
            #               for a cloud if this results in the wrong thing
            #               being in interface_ip
