...
from zuul.driver.cpusensor import CPUSensorDriver
from zuul.driver.ramsensor import RAMSensorDriver
...
class ExecutorServer(object):
    ...
    def __init__(self, config, connections={}, jobdir_root=None,
        ...
        cpu_sensor = CPUSensorDriver(config)
        self.sensors = [
            cpu_sensor,
            RAMSensorDriver(config),
            StartingBuildsSensorDriver(self, cpu_sensor.max_load_avg)
        ]
