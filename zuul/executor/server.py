        ...
        for node in args['nodes']:
            ...
            if connection_type:
                ...
                if connection_type == "winrm":
                    ...
                    host_vars['ansible_winrm_cert_pem'] = self.winrm_pem_file
                    host_vars['ansible_winrm_cert_key_pem'] = \
                        self.winrm_key_file
                    # NOTE(tobiash): This is necessary when using default winrm
                    # self-signed certificates. This is probably what most
                    # installations want so hard code this here for now.
