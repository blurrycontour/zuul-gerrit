...
class AnsibleJobBase(object):
    ...
    def runAnsible(self, cmd, timeout, playbook, ansible_version,
        ...
        ansible_dir = self.ansible_manager.getAnsibleDir(ansible_version)
        ...
        ro_paths.append(self.ansible_manager.getAnsibleInstallDir(
            ansible_version))
    ...
    def prepareRepositories(self, update_manager):
        ...
        merger = self.getMerger(
            self.jobdir.src_root, self.merge_root, self.log)
        repos = {}
        for project in args['projects']:
