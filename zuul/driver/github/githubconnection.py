...
class GithubEventConnector:
    ...
    def __init__(self, connection):
        ...
        self._thread_pool = concurrent.futures.ThreadPoolExecutor(
            thread_name_prefix='GithubEventProcessor')
    ...
    def run_event_forwarder(self):
        while True:
            ...
            try:
                ...
                if processor.event:
                    self.connection.logEvent(processor.event)
                    self.connection.sched.addEvent(processor.event)
            except Exception:
                self.log.exception("Exception moving GitHub event:")
            finally:
        ...
        try:
            ...
            if lock.acquire(blocking=False):
                ...
                with lock:
                    ...
                    log.debug("Updating %s is currently being updated, "
