...
class Codeowners(object):
    ...
    def _getReviewersForFileName(self, filename: str) -> List[str]:
    ...
    def parseFile(self, file: str):
        ...
        :param file: TextIOBase that shall be parsed
        """
...
class GithubEventProcessor(object):
    ...
    def _event_team(self):
        ...
        if (action == 'edited' or action == 'added_to_repository' or
...
class CachedGithubTeam(object):
    ...
    def from_github3_team(cls,
        ...
        return cls(team.name, iter(member.name for member in team.members()))
...
class GithubConnection(BaseConnection):
    ...
    def getTeamsForRepo(self,
        ...
        return [(self._team_cache[team_name], team_permission)
