    ...
    def _buildAnnotationsFromComments(self, file_comments):
        ...
        for fn, comments in file_comments.items():
            for comment in comments:
                ...
                # Github only accepts annotations with a valid annotation_level
                if annotation_level not in ["notice", "warning", "failure"]:
                    # Use warning as default level if none is provided or
                    # invalid
