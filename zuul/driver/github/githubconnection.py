        ...
        if event:
            ...
            if event.branch:
                ...
                if b is not None:
                    ...
                    # this case we assume that the branch has been deleted and
                    # COULD have been protected before. The cache update is
                    # handled by the push event, so we don't touch the cache
                    # here again.
