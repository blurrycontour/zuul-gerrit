...
class GithubConnection(BaseConnection):
    ...
    def getProjectBranches(self, project, tenant):
        ...
        # NOTES: If we set protected=1 to list branched, but no repository admin
        # permission, github API will raise 404. Params impact paging next link,
        # so we have to try and decide it before go into paging logic.
