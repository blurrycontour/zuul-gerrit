...
class DatabaseSession(object):
    ...
    def getBuilds(self, tenant=None, project=None, pipeline=None,
        ...
        if complete is True:
            q = q.filter(build_table.c.result is not None)
        elif complete is False:
            q = q.filter(build_table.c.result is None)
    ...
    def getBuildsets(self, tenant=None, project=None, pipeline=None,
        ...
        if complete is True:
            q = q.filter(buildset_table.c.result is not None)
        elif complete is False:
            q = q.filter(buildset_table.c.result is None)
