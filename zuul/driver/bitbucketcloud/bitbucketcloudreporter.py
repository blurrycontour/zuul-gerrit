...
class BitbucketCloudReporter(BaseReporter):
    ...
    def report(self, item):
        ...
        # TODO For supporting several BitbucketCloud connections we'll also need to filter by
        # the canonical hostname + workspace, as differentiating repos would use
