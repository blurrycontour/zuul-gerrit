...
class GerritEventFilter(EventFilter):
    ...
    def preFilter(self, event):
        ...
        # If the event might trigger Zuul reconfiguration actions, it
        # matches:
        ...
        # If it's related to a change, pass it through because we may
        # need to compare it to changes already in a pipeline.
