...
class FedmsgReporter(BaseReporter):
    """Sends off reports to Fedmsg."""

    name = 'fedmsg'
    log = logging.getLogger("zuul.FedmsgReporter")

    def report(self, item):
        """Send the compiled report message via fedmsg."""
        ...
        for job in item.getJobs():
            ...
            if not build:
                # build hasn't began. The fedmsg reporter can only send back
