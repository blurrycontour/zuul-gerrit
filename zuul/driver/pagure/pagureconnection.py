...
#   https://pagure.io/pagure/issue/4400
...
# Driver Improvements
# TODO(fbo): Use BaseConnection.logEvent

# Seen issues
# TODO(fbo): Fix issue: PR with .zuul.yaml changes
# on commit 1
# check: jobs [noop]
# on commit 2:
# check: jobs [noop2]
...
class PagureConnection(BaseConnection):
    ...
    def getChangesDependingOn(self, change, projects, tenant):
        ...
        # a str in commit_start commit msg or PR message body. Not a blocker
        # for now.
        return []
