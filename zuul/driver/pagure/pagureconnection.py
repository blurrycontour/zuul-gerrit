...
def _sign_request(body, secret):
    payload = parse.parse_qs(body).get(b'payload')[0]
    signature = hmac.new(
        secret.encode('utf-8'), payload, hashlib.sha1).hexdigest()
...
class PagureConnection(BaseConnection):
    ...
    def __init__(self, driver, connection_name, connection_config):
        ...
        self.pagure = PagureAPIClient(self.server)
    ...
    def getPull(self, project_name, number):
        ...
        # https://pagure.io/pagure/issue/3686
