...
#       sqlreporter:
#
# Pagure is similar to Github as it handle Pullrequest where PR is a branch
# compose of one or more commits. A PR can be commented, evaluated, updated,
...
# that contains a :thumbsup: or :thumbsdown: emoji. Pagure compute a score
# based on that and allow or not the merge of PR is the "minimal score to merge"
# is set in repository settings. This driver use that feature that need to be
...
# - Always merge (? trully better to match internal merge strategy of Zuul)
