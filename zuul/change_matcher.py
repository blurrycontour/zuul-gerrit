...
"""
This module defines classes used in filtering changes based on job
configuration.
"""
...
class AbstractChangeMatcher(object):
    """
    A filter that can match a change.
    """
    ...
    def matches(self, change):
        """Return a boolena indication of whether this filter matches
        the provided change.
        """
