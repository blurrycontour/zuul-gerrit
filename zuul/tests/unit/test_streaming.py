...
import zuul.tests.base
from zuul.tests.base import iterate_timeout, ZuulWebFixture
...
class TestLogStreamer(zuul.tests.base.BaseTestCase):
...
class TestStreaming(zuul.tests.base.AnsibleZuulTestCase):
