...
from zuul.tests.fakegithub import FakeGithubEnterpriseClient
from zuul.driver.github.githubconnection import GithubShaCache
import zuul.rpcclient

from zuul.tests.base import (AnsibleZuulTestCase, BaseTestCase,
...
class TestGithubDriver(ZuulTestCase):
    ...
    def test_pull_github_files_error(self):
        ...
        with mock.patch("zuul.tests.fakegithub.FakePull.files") as files_mock:
