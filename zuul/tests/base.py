...
class FakeGithubPullRequest(object):
    ...
    def addReview(self, user, state, granted_on=None):
        ...
        self.reviews.append(zuul.tests.fakegithub.FakeGHReview({
            'state': state,
            'user': {
                'login': user,
...
class FakeGithubClientManager(GithubClientManager):
    github_class = zuul.tests.fakegithub.FakeGithubClient
    github_enterprise_class = zuul.tests.fakegithub.FakeGithubEnterpriseClient
...
class FakeGithubConnection(githubconnection.GithubConnection):
    ...
    def __init__(self, driver, connection_name, connection_config, rpcclient,
        ...
        self.github_data = zuul.tests.fakegithub.FakeGithubData(changes_db)
