...
server.use(
  jsonServer.rewriter({
    ...
    '/api/*': '/$1',
    // Make all endpoints (e.g. builds, buildsets, nodes, projects, ...)
    // available per tenant. This will e.g. rewrite /tenant/opendev/build/123
    // to /build/123.
    '/tenant/*/*/:id': '/$2/:id',
    // The Zuul API serves single resources under a different path e.g.
    // build/123 instead of builds/123.
    '/build/:id': '/builds/:id',
