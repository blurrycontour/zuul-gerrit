...
const builds = [
  ...
  {
    uuid: '7b9b1fdc99854d5195b92426bfd9240a',
    job_name: 'propose-translation-update',
    result: 'SUCCESS',
    held: false,
    start_time: '2020-11-05T09:30:45',
    end_time: '2020-11-05T09:38:39',
    duration: 474.0,
    voting: true,
    log_url:
      'https://07bda34aab9549eeca55-002c6183c0f1ab9234471cb74705bd70.ssl.cf5.rackcdn.com/periodic/opendev.org/openstack/trove/master/propose-translation-update/7b9b1fd/',
    node_name: null,
    error_detail: null,
    final: true,
    artifacts: [
      {
        name: 'Download all logs',
        url:
          'https://07bda34aab9549eeca55-002c6183c0f1ab9234471cb74705bd70.ssl.cf5.rackcdn.com/periodic/opendev.org/openstack/trove/master/propose-translation-update/7b9b1fd/download-logs.sh',
        metadata: {
          command:
            'curl "https://07bda34aab9549eeca55-002c6183c0f1ab9234471cb74705bd70.ssl.cf5.rackcdn.com/periodic/opendev.org/openstack/trove/master/propose-translation-update/7b9b1fd/download-logs.sh" | bash',
        },
      },
      {
        name: 'Zuul Manifest',
        url:
          'https://07bda34aab9549eeca55-002c6183c0f1ab9234471cb74705bd70.ssl.cf5.rackcdn.com/periodic/opendev.org/openstack/trove/master/propose-translation-update/7b9b1fd/zuul-manifest.json',
        metadata: {
          type: 'zuul_manifest',
        },
      },
    ...
    newrev: null,
    ref_url: 'https://opendev.org/openstack/trove/commit/None',
    event_id: '7558b85644e042af8d5a8655559abcd5',
    buildset: {
      uuid: 'f2d681bed4ad4c91812534665159be14',
    },
  },
  {
    uuid: 'de717d86d7214ceaaaf946f819bddfcb',
    job_name: 'opendev-release-python',
    result: 'SUCCESS',
    held: null,
    start_time: '2020-02-17T16:27:27',
    end_time: '2020-02-17T16:31:55',
    duration: 268.0,
    voting: true,
    log_url:
      'https://9cb2453be18a21146f0e-851bc27c9f851efcee4b5b84902e6dca.ssl.cf5.rackcdn.com/ff70a9871e03b4285c0cbf7e0bf983d581015015/release/opendev-release-python/de717d8/',
    node_name: null,
    error_detail: null,
    final: true,
    artifacts: [
      {
        name: 'Zuul Manifest',
        url:
          'https://9cb2453be18a21146f0e-851bc27c9f851efcee4b5b84902e6dca.ssl.cf5.rackcdn.com/ff70a9871e03b4285c0cbf7e0bf983d581015015/release/opendev-release-python/de717d8/zuul-manifest.json',
        metadata: {
          type: 'zuul_manifest',
        },
      },
    ...
    change: null,
    patchset: null,
    ref: 'refs/tags/0.15.0',
    newrev: 'ff70a9871e03b4285c0cbf7e0bf983d581015015',
    ref_url:
      'https://opendev.org/opendev/gear/commit/ff70a9871e03b4285c0cbf7e0bf983d581015015',
    event_id: '2c69a2de00454043aa6219d3410ec864',
    buildset: {
      uuid: 'f3ea44de95044124a701af57098604b9',
    },
  },
  // NOTE (felix): This build must be the last in the list. Otherwise,
  // json-server will throw some weird exception
  // "TypeError: Cannot read property 'toString' of null"
  // when trying to access a build tht is defined after this one in the list.
  // Most probably because the uuid is null and json-server tries to do
  // something with it (e.g. sorting, filtering).
  {
    uuid: null,
