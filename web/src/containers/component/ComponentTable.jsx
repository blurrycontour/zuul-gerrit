...
function ComponentTable({ components }) {
  ...
  useEffect(() => {
    ...
    // Since we are changing the state in our effect, we must define an empty
    // dependency array to execute the effect only once. By default, effects
    // are executed after every render. However as changing the state results
    // in a re-render, we would end up in an infinity render loop.
    // Although this emits warnings in the browser console it's the only
    // way I know.
  }, [])
