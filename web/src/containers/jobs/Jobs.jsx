      ...
      <div className="tree-view-container">
        <Form inline>
          <FormGroup controlId='jobs'>
            <FormControl
              type='text'
              placeholder={I18n.t('jobsContainer.jobs.jobName')}
              defaultValue={filter}
            ...
            {filter && (
              <FormControl.Feedback>
                ...
                >
                  <Icon type='pf' title={I18n.t('jobsContainer.jobs.clearFilter')} name='delete' />
                  &nbsp;
                </span>
              </FormControl.Feedback>
            )}
          ...
          <FormGroup controlId='jobs-flatten'>
            &nbsp; <Translate value='jobsContainer.jobs.flattenList' /> &nbsp;
            <Checkbox
