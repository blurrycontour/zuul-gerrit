...
import { OffIcon, BullhornIcon } from '@patternfly/react-icons'
...
class Change extends React.Component {
  ...
  renderDequeueButton () {
      return (
        ...
        <OffIcon title="Dequeue this change" />
        </Button>
      )
  }
  ...
  renderDequeueModal() {
    ...
    return (
      <Modal
        ...
        actions={[
          <Button variant="primary" onClick={this.dequeueConfirm}>Confirm</Button>,
          <Button variant="link" onClick={this.dequeueCancel}>Cancel</Button>,
        ]}>
