...
// | |
// F G
const createTree = (changeQueue) => {
  // TODO (felix): Support queues with multiple heads (multiple items at
  // the beginning of a queue).

  // Root of the tree
  let tree = null
  changeQueue.heads.forEach(_head => {
    // Pointer to the current item when iterating over the queue
    let node = null
