...
class HostTask extends React.Component {
  ...
  render () {
    ...
    if (this.state.failed) {
      label = <Label color='red' onClick={this.open}  style={{cursor: 'pointer'}}>FAILED</Label> 
    } else if (this.state.changed) {
      label = <Label color='orange' onClick={this.open} style={{cursor: 'pointer'}}>CHANGED</Label>
    } else if (this.state.skipped) {
      label = <Label color='grey' onClick={this.open} style={{cursor: 'pointer'}}>SKIPPED</Label>
    } else if (this.state.ok) {
      label = <Label color='green' onClick={this.open} style={{cursor: 'pointer'}}>OK</Label>
    }
    ...
    dataListCells.push(
      <DataListCell key='node'>
        <Chip isReadOnly={true}><span style={{ fontSize: 'var(--pf-global--FontSize--md)' }}><ContainerNodeIcon />&nbsp;{hostname}</span></Chip>
      </DataListCell>
    )
...
class Console extends React.Component {
  ...
  render () {
    ...
    return (
      <React.Fragment>
        <DataList isCompact={true} className="zuul-console" style={{ fontSize: 'var(--pf-global--FontSize--md)' }}>
