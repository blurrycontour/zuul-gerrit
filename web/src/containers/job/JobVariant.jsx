...
class JobVariant extends React.Component {
  ...
  render () {
    ...
    jobInfos.forEach(key => {
      ...
      rows.push({label: <Translate value={label} />, value: value})
    })
    const jobInfosList = [
    ...
    jobInfosList.forEach(key => {
        ...
        <ul className='list-group'>
          {values.map((value, idx) => {
            ...
            if (label === 'required projects') {
              ...
              if (value['soft']) {
                item = <Translate value='softDependency' dependency={value['name']} />
              } else {
                item = value['name']
              }
            } else {
      ...
      rows.push({label: <Translate value={label} />, value: items})
    })
    return (
      <div>
