...
import logo from '../images/logo.compact.svg'
import header_bg from '../images/bg01.png'
      ...
      return (
        <React.Fragment>
          <PageSection
            ...
            style={{ backgroundImage: `linear-gradient(to bottom, #0066cc, #37c0fb), url(${header_bg})` }}>
            <Grid>
              <GridItem span={11}>
                <TextContent>
              ...
              <GridItem span={1}>
                <a href='https://zuul-ci.org'>
                  <img src={logo} style={{ height: 80 }} alt='Zuul Logo' />
                </a>
              </GridItem>
            </Grid>
          </PageSection>
