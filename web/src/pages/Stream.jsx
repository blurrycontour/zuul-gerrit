...
class StreamPage extends React.Component {
  ...
  componentDidMount() {
    ...
    document.title = I18n.t('streamPage.title', {id: params.uuid.slice(0, 7)})
    ...
    this.ws = new Sockette(getStreamUrl(this.props.tenant.apiPrefix), {
      ...
      onclose: e => {
       ...
       this.onMessage(I18n.t('streamPage.endOfStream'))
      },
      onerror: e => {
