...
class ProjectsPage extends React.PureComponent {
  ...
  render () {
    ...
    // Give enough room for the advanced search bar to fold down
    // when only a few results.
    // Could be a PF bug; see https://github.com/patternfly/patternfly/issues/4331
    let minHeight = '550px'
    ...
    return (
      <React.Fragment>
        <PageSection
          ...
          style={{'--pf-u-min-height--MinHeight': minHeight}}
        >
          <Flex>
            <FlexItem>
