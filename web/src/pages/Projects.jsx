...
function selectProjects(state) {
  ...
  return projects.filter(function (project) {
    let results = []
    if (filterTerms.name) {
      results.push(project.name.includes(filterTerms.name))
    }
    if (filterTerms.haswords) {
      results.push(project.name.includes(filterTerms.haswords))
    }
    if (filterTerms.connection_name) {
      results.push(project.connection_name.includes(filterTerms.connection_name))
    }
    if (filterTerms.type) {
      results.push(project.type.includes(filterTerms.type))
    }
