...
total_openstack_usage = sum(map(lambda x: x[1], scraper.sorted_projects))
percentage = (total_openstack_usage / scraper.total_usage) * 100
print('Total OpenStack usage: %.2fs, %.2f%%' %
      (total_openstack_usage, percentage))
print()
