...
.. note::
   ...
   The web dashboard source code and package.json is located in the ``web``
   directory. All the yarn command needs to be executed from the ``web``
   directory.
...
build outputs into the ``web/build`` directory, as long as
