...
score. For that we will use Rendezvous/HRW (highest random weight) hashing to
build a priority list of candidate launchers. The launcher with the highest
score will lock and process a request or node.
