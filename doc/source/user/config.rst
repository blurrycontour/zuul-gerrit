...
.. attr:: job
   ...
   .. attr:: roles
      ...
      project is the project in which this job definition appears, the
      branch in which this definition appears will be used.  In other
      words, a playbook may not use a role from a different branch of
      the same project.
