...
**swift**
  ...
  containers can be listed for each job.

  *name*
    Set an identifying name for the container. This is only used to
    instruct the builder what it is expected to place in the container.
