...
using the include directive.  It accepts a list of files to include,
and currently supports one type of inclusion, a python file::
...
**parameter-function (optional)**
  ...
  included with the :ref:`include` directive.  The function
