...
The order of the jobs listed in the project (which generally doesn't
matter except that it determines the order of the jobs listed on the
report for the change) will be the jobs from each template in the
order listed, followed by any jobs individually listed for the
project.
