...
**trigger**
  ...
  **gerrit**
    ...
    *delete-ignores*
    ...
    of all zeros specified. The ``delete-ignores`` field is a boolean value
    that can be set to ``True`` in order to not trigger these ref-updated events
    with a newrev of all zeros.
