...
.. attr:: job
   ...
   .. attr:: files
      ...
      either directly or via inheritance from jobs defined in the same
      project, will be implicitly added if ``files`` is set; i.e. the
      job will run if any of the playbooks it uses are modified in the
      change.
