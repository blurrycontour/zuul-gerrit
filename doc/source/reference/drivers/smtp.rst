...
.. attr:: <smtp connection>
   ...
   .. attr:: certfile
      ...
      certificate. Ignored when :attr:`<smtp connection>.use_starttls` is not
      enabled.
   ...
   .. attr:: keyfile
      ...
      :attr:`<smtp connection>.certfile` as well. Ignored when
      :attr:`<smtp connection>.use_starttls` is not enabled.
