...
.. attr:: <smtp connection>
   ...
   .. attr:: certfile
      ...
      Optional path to a single file in PEM format containing the certificate.
      Ignored when ``use_starttls`` is not enabled.

   .. attr:: keyfile

      Optional path to a single file containing the private key. If not set,
