...
This can be enable at Group level or Project level in "Settings/Webhooks"
...
.. attr:: <gitlab connection>
   ...
   .. attr:: api_token_name
      ...
      Set this parameter if authentification to clone projects is required
   ...
   .. attr:: cloneurl
      ...
      Leave blank to clone using http(s)
      or set to 'ssh://git@{server}'
