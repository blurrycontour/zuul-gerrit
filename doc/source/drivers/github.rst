...
.. attr:: pipeline.trigger.<github source>
   ...
   .. attr:: require
      ...
      This may be used for any event.  It requires that certain
      conditions be met by the PR in order for the trigger event to
   ...
   .. attr:: reject
      ...
      :attr:`pipeline.trigger.<github trigger>`.  It requires that
      certain conditions be met by the PR in order for the trigger
      event to match.  Those conditions may be satisfied by the event
      in question.  It follows the same syntax as
