...
.. attr:: pipeline.trigger.<gerrit source>
   ...
   .. attr:: require
      ...
      conditions be met by the change in order for the trigger event
   ...
   .. attr:: reject
      ...
      :attr:`pipeline.trigger.<github source>.require`.  It requires
      that certain conditions be met by the change in order for the
      trigger event to match.  Those conditions may be satisfied by
