...
.. attr:: pipeline.trigger.<gerrit source>
   ...
   .. attr:: event
      ...
      The `stream-event
      <https://gerrit-review.googlesource.com/Documentation/cmd-stream-events.html#_change_abandoned>`
      name from Gerrit. This field is treated as a regular expression.
