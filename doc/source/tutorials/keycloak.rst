...
.. code-block:: shell
   ...
   sudo -E [podman|docker]-compose -p zuul-tutorial down
...
.. code-block:: shell
   ...
   cd zuul/doc/source/examples
   ZUUL_TUTORIAL_CONFIG="./keycloak/etc_zuul/" sudo -E [podman|docker]-compose -p zuul-tutorial up -d
...
.. code-block:: shell
   ...
   sudo -E [podman|docker]-compose -p zuul-tutorial-keycloak up -d
