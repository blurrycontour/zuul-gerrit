...
.. code-block:: bash
  ...
  nose
  git+http://localhost:8080/test2.git
...
.. code-block:: YAML
  ...
  - job:
      ...
      required-projects:
        ...
        - test2
      vars:
        zuul_work_dir: "{{ zuul.projects['sftests.com/test1'].src_dir }}"
  ...
  zuul:
    ...
    - branch: master
      ...
      project:
        ...
        canonical_name: sftests.com/test1
        name: test1
        short_name: test1
        src_dir: src/sftests.com/test1
    job: tox-demorepo
    jobtags: []
    ...
    projects:
      sftests.com/test2:
        canonical_hostname: sftests.com
        canonical_name: sftests.com/test2
        checkout: master
        name: test2
        required: true
        short_name: test2
        src_dir: src/sftests.com/test2
      sftests.com/test1:
        canonical_hostname: sftests.com
        canonical_name: sftests.com/test1
        checkout: master
