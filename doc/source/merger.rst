...
To clean them you can use zuul-clear-refs.py tool script on each
repositories. It will delete Zuul references that points to commit for
which the commit date is older than a given amount of days (default
360)::
