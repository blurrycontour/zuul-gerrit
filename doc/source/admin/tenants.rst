...
``tenant``. Alternatively the :attr:`scheduler.tenant_config_script`
...
tenant YAML formated output. When :attr:`scheduler.tenant_config_script`
is set :attr:`scheduler.tenant_config` is ignored.
