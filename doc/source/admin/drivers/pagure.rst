...
.. attr:: pipeline.trigger.<pagure source>
   ...
   .. attr:: comment
      ...
      This is only used for ``pg_pull_request`` ``comment`` action.  It
   ...
   .. attr:: status
      ...
      This is used for ``pg_pull_request`` and ``status`` action. It
   ...
   .. attr:: tag
      ...
      This is used for ``pg_pull_request`` and ``tagged`` action. It
