...
.. attr:: executor
   ...
   .. attr:: max_starting_builds
      ...
      by the :attr:`load_multiplier`. E.g., on a system with 2 CPUs: 2 * 2.5 * 2
      - up to 10 starting builds may run on such executor.

      On system with high CPU/vCPU count an executor may accept too many
