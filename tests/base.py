...
class FakeGerritChange(object):
    ...
    # TODO(thenkel): This is used as a translation layer between the tests which
    #                use lower case labels. This can be removed if all tests are
    #                converted to use the correct casing.
