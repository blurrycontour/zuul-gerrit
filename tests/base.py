...
# FIXME JK: Does not work in Python 3.5.x - probably problem with some deps
# M = TypeVar('M')
# Matcher = Optional[Union[Callable[[int, M], bool], Iterable[M]]]
Matcher = Optional[Any]  # Due to the bug above
...
class SchedulerTestManager:
    ...
    def execute(self, function: Callable[[Any], None],
                matcher: Matcher[SchedulerTestApp] = None) -> None:
