...
class FakeGerritChange(object):
    ...
    def __init__(self, gerrit, number, project, branch, subject,
        ...
        self.upstream_root = upstream_root
        self.addPatchset(files=files, parent=parent, merge_branch=merge_branch)
    ...
    def addFakeChangeToRepo(self, msg, files, large, parent,
        ...
        if merge_branch:
            repo.git.merge('--no-ff', merge_branch)
...
class FakeGitlabConnection(gitlabconnection.GitlabConnection):
    ...
    def getPushEvent(
            self, project, branch='refs/heads/master',
