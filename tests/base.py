...
class ZuulTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.setup_config()
        private_key_file = os.path.join(self.test_root, 'test_id_rsa')
        if not os.path.exists(private_key_file):
            src_private_key_file = os.path.join(FIXTURE_DIR, 'test_id_rsa')
            shutil.copy(src_private_key_file, private_key_file)
            os.chmod(private_key_file, 0o0600)
        ...
        self.config.set('executor', 'private_key_file', private_key_file)
