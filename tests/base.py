...
class ZuulTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        zuul.zk.zookeeper_class = TestZooKeeper
        ...
        self.fake_nodepool = FakeNodepool(
            ...
            zk_chroot_fixture.zookeeper_port,
            zk_chroot_fixture.zookeeper_chroot)
        self.zk = ZooKeeperConnection(hosts=self.zk_config).connect()
    ...
    def assertEmptyBuildQueueHistory(self):
        ...
        try:
            ...
            for path, build in self.zk.builds.inState('ALL'):
    ...
    def __areAllBuildsWaiting(self, matcher) -> bool:
        for app in self.scheds.filter(matcher):
            ...
            for build in builds:
                ...
                build_item = self.zk.builds.getCached(build.zookeeper_node)
                ...
                if self.executor_server.hold_jobs_in_queue_sensor.pause\
                        and not self.zk.builds.isLocked(build.zookeeper_node)\
