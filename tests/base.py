...
class FakeLaunchServer(zuul.launcher.ansiblelaunchserver.LaunchServer):
    def __init__(self, config):
        self.ZMQ_port = None
        super(FakeLaunchServer, self).__init__(config)
...
class ZuulAnsibleLauncherTestCase(ZuulTestCase):
    def setUp(self):
        ...
        self.ansible_launcher = FakeLaunchServer(self.config)
