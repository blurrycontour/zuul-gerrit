...
class FakeGerritChange(object):
    ...
    def queryHTTP(self):
        ...
        if self.depends_on_change:
            parent = self.depends_on_change.patchsets[self.depends_on_patchset-1]['revision']
    ...
    def queryRevisionHTTP(self, revision):
        ...
        if self.depends_on_change:
            changes.append({
                "commit": {
                    "commit": self.depends_on_change.patchsets[self.depends_on_patchset-1]['revision'],
                },
