...
class TestRequirementsApprovalNewerThan(ZuulTestCase):
    tenant_config_file = 'config/requirement-newer-than/main.yaml'
    ...
    def _test_require_approval_newer_than(self, project, job):
        ...
        A.addApproval('approved', 1, username='jenkins',
...
class TestRequirementsOlderThan(ZuulTestCase):
    tenant_config_file = 'config/requirement-older-than/main.yaml'
...
class TestRequirementsUserName(ZuulTestCase):
    tenant_config_file = 'config/requirement-username/main.yaml'
...
class TestRequirementsEmail(ZuulTestCase):
    tenant_config_file = 'config/requirement-email/main.yaml'
