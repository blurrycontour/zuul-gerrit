...
class TestZuulClientConsoleStream(BaseTestWeb, AnsibleZuulTestCase):
    def test_console_stream(self):
        ...
        # give some time to the CLI call
        for x in iterate_timeout(180, "console-stream subcommand"):
        ...
        self.assertTrue(file_contents in str(output))
