...
class TestScheduler(testtools.TestCase):
    ...
    def test_push_urls(self):
        ...
        replica1 = os.path.join(self.upstream_root, 'org/project-replica1')
        replica2 = os.path.join(self.upstream_root, 'org/project-replica2')
        ...
        r1 = git.Repo.clone_from(upstream_path, replica1)
        r2 = git.Repo.clone_from(upstream_path, replica2)
