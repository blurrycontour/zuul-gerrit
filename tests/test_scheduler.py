...
class TestSchedulerMerges(ZuulTestCase):
    ...
    def test_merge_conflict(self):
        self.launch_server.hold_jobs_in_build = True
        A = self.fake_gerrit.addFakeChange('org/project-merge', 'master', 'A')
        A.addPatchset({'conflict': 'contentA'})

        B = self.fake_gerrit.addFakeChange('org/project-merge', 'master', 'B')
        B.addPatchset({'conflict': 'contentB'})

        C = self.fake_gerrit.addFakeChange('org/project-merge', 'master', 'C')
