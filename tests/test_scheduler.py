...
jobs:
  - name: job_name
    ...
    def test_zuul_refs(self):
        ...
        self.assertTrue(c_build.hasChanges(A))
        self.assertTrue(c_build.hasChanges(B))
        self.assertTrue(c_build.hasChanges(C))
        self.assertFalse(c_build.hasChanges(D))

        # should have a and b in 1, c and d in 2
        self.assertFalse(d_build.hasChanges(A, B, C, D))
