...
class TestScheduler(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.git_root = os.path.join(self.test_root, "zuul-git")
...
For CI problems and help debugging, contact ci@example.org"""
    ...
    def test_cloner(self):
        ...
        if False:
            ...
            log.debug("Work Repo1 origin refs: %s", work_repo1.remotes.origin.refs)
            ...
            log.debug("Work Repo2 origin refs: %s", work_repo2.remotes.origin.refs)
