...
class FakeURLOpener(object):
    ...
    def read(self):
        ...
        ret += '000000a31270149696713ba7e06f1beb760f20d359c4abed HEAD\x00multi_ack thin-pack side-band side-band-64k ofs-delta shallow no-progress include-tag multi_ack_detailed no-done\n'
        path = os.path.join(UPSTREAM_ROOT, project)
        repo = git.Repo(path)
