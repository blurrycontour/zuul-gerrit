...
For CI problems and help debugging, contact ci@example.org"""
    ...
    def test_old_patchset_doesnt_trigger(self):
        ...
        self.assertEqual(old_history_count, 1) # one check job for ps2
        self.worker.hold_jobs_in_build = True
        ...
        # Should have two changes cached. change 1,1 and 1,2
        self.assertEqual(len(self.gerrit._change_cache.keys()), 2)
