...
class TestBitbucketDriver(unittest.TestCase):
    ...
    def test_getSource(self):
        drv = BitbucketDriver()
        self.assertIsInstance(drv.getSource(drv.getConnection('foo', {})), BitbucketSource)

    def test_getConnection(self):
        drv = BitbucketDriver()
        self.assertIsInstance(drv.getConnection('foo', {}), BitbucketConnection)