...
class CommonConnectionTest(unittest.TestCase):
	realProject = 'sys-ic/foobar'
	realGitUrl = 'ssh://git@bitbucket.glumfungl.net:59/sys-ic/foobar.git'
	realWebUrl = 'https://bitbucket.glumfungl.net/projects/SYS-IC/repos/foobar/browse'

	def _connection(self):
		con = BitbucketConnection(None, 'tester', 
			{'server': 'bitbucket.glumfungl.net',
			 'server_git_port': 59,
			 'server_rest_port': 43,
			 'server_user': 'mark',
			 'server_pass': 'foobar'})
			...
			return json.loads('''
{
    ...
    "start": 0
		...
		elif path == '/rest/api/1.0/projects/sys-ic/repos/foobar/pull-requests':
			return json.loads('''
{
    "size": 1,
    "limit": 25,
    ...
    "start": 0
				...
				''')
		elif path == '/rest/api/1.0/projects/sys-ic/repos/foobar/pull-requests/101':
			return json.loads('''
{
    "id": 101,
    "version": 1,
        ...
        "self": [
            {
				...
				''')
		elif path == '/rest/api/1.0/projects/sys-ic/repos/foobar/pull-requests/101/merge':
			return json.loads('''
{
    "canMerge": false,
    "conflicted": true,
