...
class TestTenant(BaseTestCase):
    def test_add_project(self):
        tenant = model.Tenant('tenant')
        source1 = DummySource(None, None, 'git1.example.com')

        source1_project1 = model.Project('project1', None, source1)
        ...
        source1_project2 = model.Project('project2', None, source1)
        ...
        source2 = DummySource(None, None, 'git2.example.com')

        source2_project1 = model.Project('project1', None, source2)
        ...
        source2_project2 = model.Project('project2', None, source2)
        ...
        source1_project2b = model.Project('subpath/project2', None, source1)
        ...
        d = {'project1':
             ...
             {'git1.example.com': source1_project2,
              'git2.example.com': source2_project2},
             'subpath/project2': source1_project2b}
        self.assertEqual(d, tenant.projects)
        self.assertEqual((False, source1_project2),
                         tenant.getProject('git1.example.com/project2'))
        self.assertEqual((True, source2_project2),
        ...
        source2_project2b = model.Project('subpath/project2', None, source2)
