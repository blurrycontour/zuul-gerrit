...
class TestJob(BaseTestCase):
    ...
    def test_job_variants(self):
        ...
        py27_post = model.PlaybookContext(self.context, 'py27-post', [], secrets)
...
''')[0]['secret']
        ...
        untrusted_secrets_untrusted_child_job = configloader.JobParser.fromYaml(
            tenant, layout, {
                '_source_context': self.untrusted_context,
                '_start_mark': self.start_mark,
        ...
        self.assertEqual(
            len(untrusted_secrets_untrusted_child_job.implied_run[0].secrets), 0)
