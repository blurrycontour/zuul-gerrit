...
class TestScheduler(ZuulTestCase):
    ...
    def test_delayed_merge_conflict(self):
        ...
        self.executor_server.release('1,1', match='changes')
        self.waitUntilSettled()
        self.executor_server.release('1,1', match='changes')
        self.waitUntilSettled()
        ...
        self.assertHistory([
            ...
            dict(name='project-test1', result='MERGER_FAILURE', changes='2,1'),
            dict(name='project-test2', result='MERGER_FAILURE', changes='2,1'),
            dict(name='project-merge', result='MERGER_FAILURE', changes='2,1 3,1'),
            dict(name='project-test1', result='MERGER_FAILURE', changes='2,1 3,1'),
            dict(name='project-test2', result='MERGER_FAILURE', changes='2,1 3,1'),
        ], ordered=False)
