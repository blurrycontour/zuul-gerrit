...
class TestScheduler(ZuulTestCase):
    ...
    def test_semaphore_one(self):
        ...
        self.launch_server.release('semaphore-one-test1')
        self.waitUntilSettled()
        ...
        self.launch_server.release('semaphore-one-test2')
        self.waitUntilSettled()
    ...
    def test_semaphore_two(self):
        ...
        self.launch_server.release('semaphore-two-test1')
        self.waitUntilSettled()
        ...
        self.launch_server.release('semaphore-two-test2')
        self.waitUntilSettled()
