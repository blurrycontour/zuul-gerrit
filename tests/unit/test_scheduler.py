...
class TestScheduler(ZuulTestCase):
    ...
    def test_parallel_changes(self):
        ...
        self.execute_server.hold_jobs_in_build = True
        A = self.fake_gerrit.addFakeChange('org/project', 'master', 'A')
        ...
        self.execute_server.release('.*-merge')
        self.waitUntilSettled()
        ...
        self.execute_server.hold_jobs_in_build = False
        self.execute_server.release()
        self.waitUntilSettled()
    ...
    def test_failed_changes(self):
        ...
        self.execute_server.failJob('project-test1', A)
    ...
    def test_failed_change_in_middle(self):
        ...
        self.execute_server.failJob('project-test1', B)
    ...
    def test_dependent_changes_dequeue(self):
        ...
        self.execute_server.failJob('project-merge', A)
    ...
    def test_head_is_dequeued_once(self):
        ...
        self.execute_server.failJob('project-test1', A)
        self.execute_server.failJob('project-test2', A)
        self.execute_server.failJob('project1-project2-integration', A)
    ...
    def test_nonvoting_job(self):
        ...
        A = self.fake_gerrit.addFakeChange('org/nonvoting-project',
                                           'master', 'A')
        A.addApproval('code-review', 2)
        self.execute_server.failJob('nonvoting-project-test2', A)
        self.fake_gerrit.addEvent(A.addApproval('approved', 1))
    ...
    def test_json_status(self):
        ...
        self.execute_server.release('project-merge')
        self.waitUntilSettled()
    ...
    def test_mutex(self):
        ...
        self.execute_server.release('mutex-one')
        self.waitUntilSettled()
        ...
        self.execute_server.release('mutex-two')
        self.waitUntilSettled()
    ...
    def test_mutex_reconfigure(self):
        ...
        self.execute_server.release('project-test1')
        self.waitUntilSettled()
    ...
    def test_live_reconfiguration_failed_root(self):
        ...
        B = self.fake_gerrit.addFakeChange('org/project', 'master', 'B')
        self.execute_server.failJob('project-merge', B)
        B.addApproval('code-review', 2)
        self.fake_gerrit.addEvent(B.addApproval('approved', 1))
        self.waitUntilSettled()
    ...
    def test_live_reconfiguration_shared_queue(self):
        ...
        self.execute_server.release('.*-merge')
        self.waitUntilSettled()
        self.execute_server.release('project1-project2-integration')
        self.waitUntilSettled()
    ...
    def test_queue_rate_limiting(self):
        ...
        self.execute_server.release('project-.*')
        self.waitUntilSettled()
...
For CI problems and help debugging, contact ci@example.org"""
    ...
    def test_client_get_running_jobs(self):
        ...
        while True:
            if time.time() - start > 10:
                raise Exception("Timeout waiting for gearman server to report "
                                + "back to the client")
            build = self.execute_client.builds.values()[0]
            if build.worker.name == "My Worker":
                break
            else:
                time.sleep(0)
    ...
    def test_disable_at(self):
        ...
        self.execute_server.failJob('project-test1', D)
        self.execute_server.failJob('project-test1', E)
        self.execute_server.failJob('project-test1', F)
        self.execute_server.failJob('project-test1', G)
        self.execute_server.failJob('project-test1', H)
        # I also passes but should only report to the disabled reporters
        self.execute_server.failJob('project-test1', J)
        self.execute_server.failJob('project-test1', K)
    ...
    def test_rerun_on_abort(self):
        ...
        self.assertEqual(len(self.builds), 2)
        self.builds[0].requeue = True
        self.execute_server.release('.*-test*')
        self.waitUntilSettled()
        ...
        for x in range(3):
            ...
            self.builds[0].requeue = True
            self.execute_server.release('.*-test1')
            self.waitUntilSettled()
...
class TestSchedulerMerges(ZuulTestCase):
    ...
    def _test_project_merge_mode(self, mode):
        self.execute_server.keep_jobdir = False
