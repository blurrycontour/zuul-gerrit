...
class TestScheduler(ZuulTestCase):
    ...
    def test_autohold_by_ref(self):
        ...
        r = client.autohold('tenant-one', 'org/project2', 'project-test3',
                            "reason text", 1, ref)
        self.assertTrue(r)

        # Fail A, nodes won't be held
        self.executor_server.failJob('project-test3', A)
        self.fake_gerrit.addEvent(A.getPatchsetCreatedEvent(1))
        self.waitUntilSettled()
        ...
        self.executor_server.failJob('project-test3', B)
        self.fake_gerrit.addEvent(B.getPatchsetCreatedEvent(1))
        self.waitUntilSettled()
        ...
        # Another failing patchset on B should not hold any more nodes
