...
class TestSchedulerAutoholdMaxHoldAge(ZuulTestCase):
    '''
    ...
    '''
    config_file = 'zuul-max-hold-age.conf'
    tenant_config_file = 'config/single-tenant/main.yaml'

    @simple_layout('layouts/autohold.yaml')
    def test_autohold_max_hold_age_default(self):
        '''
        ...
        # Add a autohold with no max_hold_age.
        ...
        # This should be the value from the zuul config file.
        self.assertEqual(3600, request.node_expiration)

    @simple_layout('layouts/autohold.yaml')
    def test_autohold_max_hold_age_custom(self):
        '''
        ...
        # Add a autohold with a custom max_hold_age.
        r = client.autohold('tenant-one', 'org/project', 'project-test2',
                            "", "", "reason text", 1, 500)
        self.assertTrue(r)
