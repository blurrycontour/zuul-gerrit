...
For CI problems and help debugging, contact ci@example.org"""
    ...
    def test_nodepool_resources(self):
        ...
        self.assertReportedStat(
            'zuul.nodepool.resources.tenant.tenant-one.cores.current',
            value='2', kind='g')
        self.assertReportedStat(
            'zuul.nodepool.resources.tenant.tenant-one.ram.current',
            value='1024', kind='g')
        self.assertReportedStat(
            'zuul.nodepool.resources.tenant.tenant-one.instances.current',
            value='1', kind='g')
        self.assertReportedStat(
            'zuul.nodepool.resources.project.review_example_com/org/project.'
            'cores.current', value='2', kind='g')
        self.assertReportedStat(
            'zuul.nodepool.resources.project.review_example_com/org/project.'
            'ram.current', value='1024', kind='g')
        self.assertReportedStat(
            'zuul.nodepool.resources.project.review_example_com/org/project.'
            'instances.current', value='1', kind='g')

        # Check that resource usage counters are reported
        self.assertReportedStat(
            'zuul.nodepool.resources.tenant.tenant-one.cores.counter',
            kind='c')
        self.assertReportedStat(
            'zuul.nodepool.resources.tenant.tenant-one.ram.counter',
            kind='c')
        self.assertReportedStat(
            'zuul.nodepool.resources.tenant.tenant-one.instances.counter',
            kind='c')
        self.assertReportedStat(
            'zuul.nodepool.resources.project.review_example_com/org/project.'
            'cores.counter', kind='c')
        self.assertReportedStat(
            'zuul.nodepool.resources.project.review_example_com/org/project.'
            'ram.counter', kind='c')
        self.assertReportedStat(
            'zuul.nodepool.resources.project.review_example_com/org/project.'
            'instances.counter', kind='c')
