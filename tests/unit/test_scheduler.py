...
class TestScheduler(ZuulTestCase):
    ...
    def test_live_reconfiguration_shared_queue_removed(self):
        ...
        # Use prime() instead of reconfigure() here so that the pipeline
        # manager does not run which would fix the wrong item state after
        # the re-enqueue.
        self.scheds.execute(lambda app: app.sched.prime(app.config))
        self.waitUntilSettled()
