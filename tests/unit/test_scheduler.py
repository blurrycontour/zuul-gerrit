...
class TestSchedulerReconfigurationHTTP(ZuulTestCase):
    ...
    def test_cache_reconfigure_branch_create_delete(self):
        "Test that cache is updated clear on branch creation/deletion"
        self.assertEqual(self.scheds.first.sched.abide.hasUnparsedBranchCache("review.example.com/org/project1", "stable"), False)
        ...
        self.fake_gerrit.addEvent(A.addApproval('Approved', 1))
        self.waitUntilSettled()
        self.assertEqual(self.scheds.first.sched.abide.hasUnparsedBranchCache("review.example.com/org/project1", "stable"), True)
