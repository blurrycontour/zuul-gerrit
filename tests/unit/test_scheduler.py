...
class TestScheduler(ZuulTestCase):
    ...
    def test_jobs_executed(self):
        ...
        self.assertReportedStat('zuul.nodepool.requests.requested',
                                value='1', kind='c')
        self.assertReportedStat('zuul.nodepool.requests.requested.label.label1',
                                value='1', kind='c')
        self.assertReportedStat('zuul.nodepool.requests.fulfilled.label.label1',
                                value='1', kind='c')
        self.assertReportedStat('zuul.nodepool.requests.requested.size.1',
                                value='1', kind='c')
        self.assertReportedStat('zuul.nodepool.requests.fulfilled.size.1',
                                value='1', kind='c')
        self.assertReportedStat('zuul.nodepool.requests.current_requests',
                                value='1', kind='g')
