...
For CI problems and help debugging, contact ci@example.org"""
    ...
    def test_pending_merge_in_reconfig(self):
        ...
        self.waitUntilSettled()
        self.log.debug("ZUUL CCCCCCCCCCCOOOOOOOUUUUbbbbbbbbbbbbbbbbbbbbbbbbbb 2")
        ...
        self.fake_gerrit.addEvent(A.getRefUpdatedEvent())
        self.waitUntilSettled()
        self.log.debug("ZUUL CCCCCCCCCCCOOOOOOOUUUUUUUUUUUUUNNNNNTTTTTTTTTTT 2")
...
class TestSchedulerTemplatedProject(ZuulTestCase):
    ...
    def test_implied_branch_matchers(self):
        ...
        self.waitUntilSettled()
        self.log.debug("ON AJOUTE CHANGE AAAAAAAAAAAAAAAAAAAAAAAAAAA")
        A = self.fake_gerrit.addFakeChange(
            'untrusted-config', 'stable', 'A')

        self.fake_gerrit.addEvent(A.getPatchsetCreatedEvent(1))
        self.waitUntilSettled()
        self.log.debug("APRES SETTLE CHANGE AAAAAAAAAAAAAAAAAAAAAAAAAAA")
...
class TestReconfigureBranch(ZuulTestCase):
    ...
    def _deleteBranch(self):
        oldrev = self.delete_branch(self.project_reconfig, 'stable')
        self.fake_gerrit.addEvent(
...
class TestReconfigureBranchCreateNoconfDeleteSshHttp(TestReconfigureBranch):
    ...
    def test_reconfigure_cache_branch_create_add_conf_delete(self):
        ...
        self.log.debug("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
...
class TestReconfigureBranchCreateConfDeleteSshHttp(TestReconfigureBranch):
    ...
    def test_reconfigure_cache_branch_create_delete(self):
        ...
        self._createBranch()
        self._expectReconfigure(True)
        # branch deletion, we know there are config files
        # reconfiguration
        self._deleteBranch()
        self._expectReconfigure(True)
