...
class TestScheduler(ZuulTestCase):
    ...
    def test_project_merge_conflict(self):
        ...
        self.assertEqual(A.reported, 1)  # Started
        self.assertEqual(B.reported, 2)  # Started and merge failure
        self.assertEqual(C.reported, 1)  # Started
    ...
    def test_delayed_merge_conflict(self):
        ...
        self.assertHistory([
            ...
            dict(name='project-test1', result='ABORTED', changes='2,1 3,1'),
            dict(name='project-test2', result='ABORTED', changes='2,1 3,1'),
        ], ordered=False)
