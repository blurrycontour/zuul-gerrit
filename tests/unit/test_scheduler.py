...
class TestScheduler(ZuulTestCase):
    ...
    def test_inherited_job_variables(self):
        ...
        vars = j.job.combined_variables
        self.assertEqual(vars['project_var'], 'set_in_project')
        self.assertEqual(vars['template_var1'], 'set_in_template1')
        self.assertEqual(vars['template_var2'], 'set_in_template2')
        self.assertEqual(vars['override'], 0)
        self.assertEqual(vars['child1override'], 0)
        self.assertEqual(vars['parent'], 0)
        self.assertEqual(vars['deep']['override'], 0)
        ...
        vars = j.job.combined_variables
        self.assertEqual(vars['project_var'], 'set_in_project')
        self.assertEqual(vars['override'], 1)
        self.assertEqual(vars['child1override'], 1)
        self.assertEqual(vars['parent'], 0)
        self.assertEqual(vars['child1'], 1)
        self.assertEqual(vars['deep']['override'], 1)
        self.assertFalse('child2' in vars)
        self.assertFalse('child3' in vars)
        self.assertEqual(rp, set(['org/project', 'org/project0',
                                  'org/project1']))
        ...
        self.assertEqual(vars['project_var'], 'set_in_project')
        rp = set([p['name'] for p in j.parameters['projects']])
        self.assertEqual(vars['override'], 2)
        self.assertEqual(vars['child1override'], 0)
        self.assertEqual(vars['parent'], 0)
        self.assertEqual(vars['deep']['override'], 2)
        self.assertFalse('child1' in vars)
        self.assertEqual(vars['child2'], 2)
        self.assertFalse('child3' in vars)
        self.assertEqual(rp, set(['org/project', 'org/project0',
                                  'org/project2']))
        ...
        self.assertEqual(vars['project_var'], 'set_in_project')
        rp = set([p['name'] for p in j.parameters['projects']])
        self.assertEqual(vars['override'], 3)
        self.assertEqual(vars['child1override'], 0)
        self.assertEqual(vars['parent'], 0)
        self.assertEqual(vars['deep']['override'], 3)
        self.assertFalse('child1' in vars)
        self.assertFalse('child2' in vars)
        self.assertEqual(vars['child3'], 3)
        self.assertEqual(rp, set(['org/project', 'org/project0',
                                  'org/project3']))
        j = self.getJobFromHistory('override_project_var')
        vars = j.job.combined_variables
        self.assertEqual(vars['project_var'], 'override_in_job')
