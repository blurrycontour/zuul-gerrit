...
class TestScheduler(ZuulTestCase):
    ...
    def test_json_status(self):
        ...
        self.assertEqual('finger://%s@zl.example.com' % status_jobs[0]['uuid'],
                         status_jobs[0]['url'])
        self.assertEqual('finger://%s@zl.example.com' % status_jobs[0]['uuid'],
                         status_jobs[0]['report_url'])
        self.assertEqual('project-test1', status_jobs[1]['name'])
        self.assertEqual('finger://%s@zl.example.com' % status_jobs[1]['uuid'],
                         status_jobs[1]['url'])
        self.assertEqual('finger://%s@zl.example.com' % status_jobs[1]['uuid'],
                         status_jobs[1]['report_url'])

        self.assertEqual('project-test2', status_jobs[2]['name'])
        self.assertEqual('finger://%s@zl.example.com' % status_jobs[2]['uuid'],
                         status_jobs[2]['url'])
        self.assertEqual('finger://%s@zl.example.com' % status_jobs[2]['uuid'],
    ...
    def test_client_get_running_jobs(self):
        ...
        for job in running_item['jobs']:
            if job['name'] == 'project-merge':
                ...
                self.assertEqual('finger://%s@zl.example.com' % job['uuid'],
                                 job['url'])
...
class TestSchedulerSuccessURL(ZuulTestCase):
    ...
    def test_success_url(self):
        ...
        # TODOv3(mordred) We don't have support for log url yet, so this
        # is getting status URL
        self.assertIn(
            '- docs-draft-test2 finger://{}@zl.example.com'.format(full_uuid),
            body[3])
