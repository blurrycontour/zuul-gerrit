...
class TestGerritToGithubCRD(ZuulTestCase):
    ...
    def test_crd_gate(self):
        ...
        B = self.fake_github.openFakePullRequest('github/project2', 'master', 'B')

        A.addApproval('Code-Review', 2)

        AM2 = self.fake_gerrit.addFakeChange('gerrit/project1', 'master', 'AM2')
        AM1 = self.fake_gerrit.addFakeChange('gerrit/project1', 'master', 'AM1')
        AM2.setMerged()
        AM1.setMerged()
    ...
    def test_crd_branch(self):
        ...
        A = self.fake_gerrit.addFakeChange('gerrit/project1', 'master', 'A')
        B = self.fake_github.openFakePullRequest('github/project2', 'master', 'B')
        C1 = self.fake_github.openFakePullRequest('github/project2', 'mp', 'C1')
    ...
    def test_crd_gate_unknown(self):
        ...
        A = self.fake_gerrit.addFakeChange('gerrit/project1', 'master', 'A')
        B = self.fake_github.openFakePullRequest('github/unknown', 'master', 'B')
        A.addApproval('Code-Review', 2)
    ...
    def test_crd_undefined_project(self):
        ...
        self.init_repo("github/unknown", tag='init')
        self._test_crd_check_reconfiguration('gerrit/project1', 'github/unknown')
...
class TestGithubToGerritCRD(ZuulTestCase):
    ...
    def test_crd_gate(self):
        "Test cross-repo dependencies"
        A = self.fake_github.openFakePullRequest('github/project2', 'master', 'A')
        B = self.fake_gerrit.addFakeChange('gerrit/project1', 'master', 'B')
    ...
    def test_crd_undefined_project(self):
        ...
        # as it implies repo creation upon the creation of any change
        self.init_repo("gerrit/unknown", tag='init')
        self._test_crd_check_reconfiguration('github/project2', 'gerrit/unknown')
    ...
    def test_crd_check_transitive(self):
        ...
        A = self.fake_github.openFakePullRequest('github/project2', 'master', 'A')
        B = self.fake_gerrit.addFakeChange('gerrit/project1', 'master', 'B')
        C = self.fake_github.openFakePullRequest('github/project2', 'master', 'C')
