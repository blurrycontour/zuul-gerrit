...
class TestZuulTriggerParentChangeEnqueued(ZuulTestCase):
    ...
    def test_zuul_trigger_parent_change_enqueued(self):
        ...
        def counting_put(*args, **kwargs):
            ...
            self.sched_factory.first.trigger_event_queue\
                .put_orig(*args, **kwargs)

        self.sched_factory.first.trigger_event_queue.put_orig = \
            self.sched_factory.first.trigger_event_queue.put
        self.sched_factory.first.trigger_event_queue.put = counting_put
