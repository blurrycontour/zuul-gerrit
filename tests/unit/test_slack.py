...
class TestSlack(TestCase):
    ...
    def test_slack_reporter(self, _slack_mock):
        ...
        calls = [
            call(api, channel="#all", text="Cfakec"),
            call(api, channel="#all", text=report, thread_ts="0.0"),
            call(api, channel="#foo", text="Cfakec"),
            call(api, channel="#foo", text=report, thread_ts="0.0"),
        ]
