...
class TestReporting(ZuulTestCase):
    ...
    @simple_layout("layouts/cancel-reporting.yaml")
    def test_cancel_reporting(self):
        """Check that explicitly dequeued items are reported as canceled"""
    ...
    @simple_layout("layouts/cancel-reporting.yaml")
    def test_cancel_reporting_gate_reset(self):
        """Check that a gate reset is not reported as canceled"""
        ...
        # None of the items should be reported as canceled, only success or
        # failure
    ...
    @simple_layout("layouts/cancel-reporting.yaml")
    def test_cancel_reporting_supercedes(self):
        """Test that a superceeded change is reported as canceled"""
    ...
    @simple_layout("layouts/cancel-reporting.yaml")
    def test_cancel_reporting_new_patchset(self):
        "Test that change superceeded by a new patchset is reported as cancel"
