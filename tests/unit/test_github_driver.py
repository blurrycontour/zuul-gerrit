...
class TestCodeownersParsing(ZuulTestCase):
    ...
    def setUp(self):
        ...
        reader = FakeGithubCollaborator('reader',
                                        permissions={'pull': True,
                                                     'admin': False,
                                                     'push': False})
        collaborators = [ghuser, reader]

        github = self.fake_github
        testorg = FakeGithubOrganization(teams)
    ...
    def test_review_from_non_codeowner(self):
        self._test_pipeline_with_codeowners(
            {'some_file.cpp': 'int main() {}'}, ['someone'], False)
    ...
    def test_review_from_codeowner_without_write_permission(self):
        ...
        """
        self._test_pipeline_with_codeowners(
            {'some_file.c': 'int main() {}'}, ['reader'], True)
    ...
    def test_codeowners_verification(self):
        ...
        assert github._hasCodeownersReview('org/project1', 'master',
                                           ['zuul.yaml'], review1)
        assert not github._hasCodeownersReview('org/project1', 'master',
                                               ['zuul.yaml'], review2)
