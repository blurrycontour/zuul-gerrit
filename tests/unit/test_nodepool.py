...
class TestNodepoolResubmit(TestNodepool):
    ...
    def test_node_request_disconnect_late(self):
        ...
        self.assertNotEqual(self.provisioned_requests[0].id,
                            self.provisioned_requests[1].id)
        self.assertEqual(len(self.provisioned_requests[0].nodeset.nodes), 2)
        self.assertEqual(len(self.provisioned_requests[1].nodeset.nodes), 2)
