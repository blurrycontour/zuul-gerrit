...
class TestGerritWeb(ZuulTestCase):
    ...
    def test_submitted_together_git(self):
        ...
        self.assertHistory([
            ...
            dict(name="project-test1", result="SUCCESS", changes="1,1 2,1 3,1"),
            dict(name="project-test2", result="SUCCESS", changes="1,1 2,1 3,1"),
            dict(name="project1-project2-integration", result="SUCCESS", changes="1,1 2,1 3,1"),
        ], ordered=False)
