...
from zuul.zk.builds import ZooKeeperBuildItem
...
class TestGovernor(ZuulTestCase):
    ...
    def test_load_governor(self, vm_mock, loadavg_mock):
        ...
        self.assertTrue(self.executor_server.zk_component
                        .get('accepting_work', False))
        ...
        self.executor_server.manageLoad()
        self.assertFalse(self.executor_server.zk_component
                         .get('accepting_work', False))
