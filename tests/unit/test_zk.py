...
class TestConfigurationErrorList(ZooKeeperBaseTestCase):
    def test_config_error_list(self):
        ...
        with tenant_write_lock(self.zk_client, 'test') as lock:
            ...
            e1 = model.ConfigurationError(source_context, start_mark, "Test error1")
            e2 = model.ConfigurationError(source_context, start_mark, "Test error2")
            ...
            el2 = model.ConfigurationErrorList.fromZK(context, path, _path=path)
