...
from zuul.zk.zkobject import (
    ShardedZKObject, VariableZKObjectMixin, ZKObject, ZKContext
)
...
class TestVariableZKObjectMixin(ZooKeeperBaseTestCase):

    def test_create(self):
        class Parent(VariableZKObjectMixin, ZKObject):
            def __init__(self):
                super().__init__()
                self._set(
                    _path=None,
    ...
    def test_missing_base(self):
        with testtools.ExpectedException(TypeError):
            class Child(VariableZKObjectMixin, subclass_id="child"):
                pass

    def test_wrong_nesting(self):
        class Parent(VariableZKObjectMixin):
            pass
    ...
    def test_independent_hierarchies(self):
        class ParentA(VariableZKObjectMixin):
            pass

        class ChildA(ParentA, subclass_id="child-A"):
            pass

        class ParentB(VariableZKObjectMixin):
            pass
