...
class TestExecutorApi(ZooKeeperBaseTestCase):
    ...
    def test_unlock_request(self):
        ...
        for _ in iterate_timeout(30, "lock to propagate"):
            ...
            if r1.is_locked and r2.is_locked:
                break

        self.assertEqual(2, r1.lock_contenders)
        self.assertEqual(2, r2.lock_contenders)
    ...
    def test_build_request_hashing(self):
        ...
        self.component_info2.state = self.component_info.RUNNING
