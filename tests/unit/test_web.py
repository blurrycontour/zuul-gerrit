...
class TestWeb(BaseTestWeb):
    ...
    def test_web_trigger_404(self):
        resp = self.post_url(
            "api/tenant/tenant-42/trigger/org/project/project-test1")
        self.assertEqual(404, resp.status_code)
        resp = self.post_url(
            "api/tenant/tenant-one/trigger/org/project42/project-test1")
        self.assertEqual(404, resp.status_code)

    def test_web_trigger_post(self):
        self.executor_server.hold_jobs_in_build = False
        result = self.post_url(
            "api/tenant/tenant-one/trigger/org/project/project-post").json()
    ...
    def test_web_trigger_variables(self):
        ...
        result = self.post_url(
            "api/tenant/tenant-one/trigger/org/project/project-test1",
