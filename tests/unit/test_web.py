...
class TestWeb(BaseTestWeb):
    ...
    def test_project_freeze_jobs(self):
        ...
        # pipeline+branch.
        resp = self.get_url(
            "api/tenant/tenant-one/freeze-jobs/org/project1/check/master")
        ...
        frozen_jobs = [{
            ...
            'pre_run': [],
            'run': [expected_pb('playbooks/project-merge.yaml')],
            'post_run': [],
        }, {
            'name': 'project-test1',
            'branches': [],
            ...
            'pre_run': [],
            'run': [expected_pb('playbooks/project-test1.yaml')],
            'post_run': [],
        }, {
            'name': 'project-test2',
            'branches': [],
            ...
            'pre_run': [],
            'run': [expected_pb('playbooks/project-test2.yaml')],
            'post_run': [],
        }, {
            'name': 'project1-project2-integration',
            'branches': [],
            ...
            'pre_run': [],
            'run': [expected_pb(
                'playbooks/project1-project2-integration.yaml')],
            'post_run': [],
        }]
    ...
    def test_frozen_job_set_includes_all_jobs(self):
        ...
        resp = self.get_url(
            "api/tenant/tenant-one/freeze-jobs/org/project/gate/master")
        expected = {
            'abstract': False,
            'attempts': 3,
            'branches': [],
            'dependencies': ['project-merge'],
            'description': None,
            # The frozen job version doesn't have the _files attribute.
            'files': [],
            'final': False,
            'implied_branch': None,
            'irrelevant_files': [],
            ...
            'roles': [{'implicit': True,
                       ...
                       'target_name': 'common-config',
                       'type': 'zuul'}],
            'run': [{'path': 'playbooks/project-testfile.yaml',
                     'roles': [{'implicit': True,
                                'project_canonical_name':
                                'review.example.com/common-config',
                                'target_name': 'common-config',
...
class TestWebSecrets(BaseTestWeb):
    ...
    def test_project_freeze_job_secret(self):
