...
class TestWeb(BaseTestWeb):
    ...
    def test_freeze_jobs_set_includes_all_jobs(self):
        ...
        expected = {
            ...
            'dependencies': ['project-merge'],
            'description': None,
            # The freeze job version doesn't have the _files attribute.
            'files': [],
            'final': False,
            'implied_branch': None,
            'irrelevant_files': [],
...
class TestWebSecrets(BaseTestWeb):
    ...
    def test_freeze_jobs_secret(self):
        # Test that secrets are not present in from any jobs
