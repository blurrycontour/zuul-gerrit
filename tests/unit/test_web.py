...
class TestRoles(BaseTestWeb):
    ...
    def test_roles_list(self):
        ...
        self.assertEquals(
            sorted(["project", "changelog", "readme", "name"]),
            sorted(ensure_python.keys())
        )
        self.assertEquals(
            sorted(["project", "readme", "name"]), sorted(foo.keys())
        )
        self.assertEquals(
            sorted(["project", "name"]), sorted(undocumented_role.keys())
        )
