...
class TestWeb(ZuulTestCase):
    ...
    def setUp(self):
        ...
        self.log.debug("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX Starting")
        ...
        self.host = 'localhost'
        self.log.debug("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX Waiting")
        ...
        self.log.debug("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX Started")
