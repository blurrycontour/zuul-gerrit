...
class TestPlugins(AnsibleZuulTestCase):
    ...
    def _run_job(self, job_name, project='org/project', roles=''):
        ...
        # Note: We expect blocking execution with an error message. In case
        # this test fails we get a RETRY_LIMIT which means that the executor
        # wrongly tried to execute the ansible playbook.
