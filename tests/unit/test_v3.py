...
class TestBrokenMultiTenantConfig(ZuulTestCase):
    ...
    def test_loading_errors(self):
        ...
        #   tenants aren't proposing changes to that repo, it doesn't
        #   matter.
        #
        ...
        # This test has two tenants.  The first loads project1,
        # project2, and project3 without errors and all config objects
        # are cached.  The second tenant loads only project1 and
        # project2.  Project2 references a job that is defined in
        # project3, so the tenant loads with an error, but proceeds.
