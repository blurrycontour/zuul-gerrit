...
class TestPipelineLimits(ZuulTestCase):
    ...
    def test_pipeline_max_changes_check(self):
        ...
        self.assertEqual(A.reported, 1)
        self.assertEqual(B.reported, 1)
        self.assertIn(f"Unable to enqueue {B}: 2 changes to enqueue "
    ...
    def test_pipeline_max_changes_current_check(self):
        ...
        self.assertEqual(A.reported, 1)
        self.assertEqual(B.reported, 1)
        self.assertIn(f"Unable to enqueue {B}: 1 additional changes would "
    ...
    def test_pipeline_max_changes_gate(self):
        ...
        self.assertEqual(B.reported, 0)
        self.assertEqual(C.reported, 1)
        self.assertIn(f"Unable to enqueue {C}: 2 changes to enqueue "
