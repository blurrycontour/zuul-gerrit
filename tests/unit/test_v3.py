...
class AddHostMixIn:
    ...
    def test_add_host(self):
        ...
        self.assertNotIn("Test group membership fake-pre", job_output)
        self.assertIn("Test group membership fake-run1", job_output)
        self.assertIn("Test group membership fake-run2", job_output)
        self.assertNotIn("Test group membership localhost", job_output)
