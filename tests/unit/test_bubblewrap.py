...
class TestBubblewrap(testtools.TestCase):
    ...
    def test_bubblewrap_wraps(self):
        ...
        po = bwrap.getPopen(work_dir=work_dir, ansible_dir=ansible_dir)
        ...
        self.assertRaises(OSError, os.close, po.passwd_r)
        self.assertRaises(OSError, os.close, po.group_r)
