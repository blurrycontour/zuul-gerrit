...
from tests.base import ZuulTestCase, FIXTURE_DIR, \
    ...
    AnsibleZuulTestCase, BaseTestCase
...
class TestSQLConnectionMysql(ZuulDBTestCase):
    ...
    def test_sql_tables_created(self):
        ...
        self._sql_tables_created('resultsdb')
    ...
    def test_sql_indexes_created(self):
        ...
        self._sql_indexes_created('resultsdb')
    ...
    def test_multiple_sql_connections(self):
        ...
        check_results('resultsdb', 'resultsdb_failures')
...
class TestSQLConnectionBadReporting(ZuulDBTestCase, AnsibleZuulTestCase):
    config_file = 'zuul-sql-driver-mysql.conf'
    tenant_config_file = 'config/sql-driver/main.yaml'

    def test_too_long_url_recover(self):
        """
        Tests that zuul recovers from errors durong db commit
